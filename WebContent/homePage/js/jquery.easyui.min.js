...
var t=$(_59);
return {id:t.attr("id"),disabled:(t.prop("disabled")?true:undefined),plain:(t.attr("plain")?t.attr("plain")=="true":undefined),text:$.trim(t.html()),iconCls:(t.attr("icon")||t.attr("iconCls"))};
};
...
_86.checked=_85.prop("checked")=="true";
...
var t=$(_368);
return $.extend({},$.fn.validatebox.parseOptions(_368),{disabled:(t.prop("disabled")?true:undefined),value:(t.val()||undefined),min:(t.attr("min")=="0"?0:parseFloat(t.attr("min"))||undefined),max:(t.attr("max")=="0"?0:parseFloat(t.attr("max"))||undefined),precision:(parseInt(t.attr("precision"))||undefined),decimalSeparator:(t.attr("decimalSeparator")?t.attr("decimalSeparator"):undefined),groupSeparator:(t.attr("groupSeparator")?t.attr("groupSeparator"):undefined),prefix:(t.attr("prefix")?t.attr("prefix"):undefined),suffix:(t.attr("suffix")?t.attr("suffix"):undefined)});
};
...
$(this).prop("readonly",!_3a0.options.editable);
...
var t=$(_3a4);
return $.extend({},$.fn.validatebox.parseOptions(_3a4),{width:(parseInt(_3a4.style.width)||undefined),value:(t.val()||undefined),min:t.attr("min"),max:t.attr("max"),increment:(parseFloat(t.attr("increment"))||undefined),editable:(t.attr("editable")?t.attr("editable")=="true":undefined),disabled:(t.prop("disabled")?true:undefined)});
};
...
$.fn.prop?_45e.prop("checked",true):_45e.prop("checked",true);
...
$.fn.prop?_462.prop("checked",false):_462.prop("checked",false);
if(opts.idField){
...
$.fn.prop?ck.prop("checked",true):ck.prop("checked",true);
if(opts.idField){
...
$.fn.prop?ck.prop("checked",false):ck.prop("checked",false);
...
$.fn.prop?$(_4da).prop("checked",_4dc):$(_4da).prop("checked",_4dc);
...
tr.addClass("datagrid-row-selected");
tr.find("div.datagrid-cell-check input[type=checkbox]").prop("checked",true);
};
...
if(_680){
opts.disabled=true;
$(_67f).prop("disabled",true);
_681.find(".combo-value").prop("disabled",true);
_681.find(".combo-text").prop("disabled",true);
}else{
opts.disabled=false;
...
$("input.combo-text",_69f.combo).prop("readonly",!_69f.options.editable);
_662(this);
